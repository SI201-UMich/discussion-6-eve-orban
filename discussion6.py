...
###############################################################################
    ...
    def horse_fastest_race(self, horse):
        ...
        for race in self.race_dict[horse]:
            time = self.race_dict[horse][race]
            if time < fast_time:
                fast_time = time
                fast_race = race

        return (fast_race, fast_time)
        # pass
...
###############################################################################
    ...
    def horse_personal_best(self):
        ...
        for horse in self.race_dict:
            ...
            fast_race_time[horse] = (fast_race, fast_time)

        return fast_race_time
...
###############################################################################
    ...
    def get_average_time(self):
        ...
        for horse in self.race_dict:
            ...
            for race in self.race_dict[horse]:
                total += self.race_dict[horse][race]
                count += 1

            avg_time_dict[horse] = total / count
